...
function documentReady() {
  orderButton.forEach((button) => {
    ...
    const productId = button.parentElement.parentElement.parentElement.id;
    button.href = `https://wa.me/97470923424?text=Hello,%20I%20would%20like%20to%20buy%20this%20product%20from%20your%20website%20https://poshboutiqueug.com/products/${productId}`;
  });
}
